...
def load_data(filename):
    ...
    with open(filename, 'r') as f:
        ...
        if filename == 'datavn/train':
            joblib.dump(train, 'model/train1_2.pkl')
        else:
            joblib.dump(train, 'model/test1_2.pkl')
    return train


def svm():
    train = load_model('model/train1_2.pkl')
    if train is None:
        train = load_data('datavn/train')

    vectorizer = load_model('model/vectorizer1_2.pkl')
    if vectorizer == None:
    ...
    joblib.dump(vectorizer, 'model/vectorizer1_2.pkl')
    ...
    if clf is None:
        ...
        joblib.dump(clf, 'model/bow1_2.pkl')
    ...
    print "-----------------------"
    clf2 = load_model('model/bow_fine1_2.pkl')
    if clf2 is None:
        t2 = time.time()
